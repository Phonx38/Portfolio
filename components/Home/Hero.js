  ...
  return (
    <div className="flex flex-col w-full  md:pt-40 justify-center items-center min-h-screen z-10 bg-gradient-to-r from-gray-700 via-gray-900 to-black  ">
      <div className=" w-full md:w-3/5 text-center flex flex-col items-center md:p-2 pl-2 pr-2 pt-10 z-10">
        <img
          className="-z-20 md:-z-10 absolute top-60 md:top-40 right-0 md:right-20 w-32 h-28   opacity-70  "
          src="https://thumbs.gfycat.com/BabyishNearBlackbear-max-1mb.gif"
          alt="back"
        />
        <img
          className="-z-20 md:-z-10 absolute top-32 left-3 md:left-20 w-32 h-24   opacity-70  "
          src="https://thumbs.gfycat.com/BabyishNearBlackbear-max-1mb.gif"
          alt="back"
        />
        <img
          className="-z-20 md:-z-10 absolute top-56 left-5 md:left-24 w-24 h-16   opacity-70  "
        ...
        />
        <img
          className="-z-20 absolute top-0 md:bottom-0  w-full h-full  opacity-70  "
